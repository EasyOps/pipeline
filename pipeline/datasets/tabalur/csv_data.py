...
from ..base import BaseDataset, DATASETS, build_from_cfg, TranformsErrorType, KeyTransformsNotInDataset
import pandas as pd
import logging
...
class CSVDataset(object):
    ...
    def __load__(self) -> Union[DatasetDict, Dataset]:
        if isinstance(self.data_files, str):
            ...
            logging.info(f"Load data from speciflic CSV file: {self.data_files} with key split is: {str_keys}")
